...
enum ClassType {
    ...
    //HomeDetailVC
    case priceLbl, depositLbl, sumLbl, viewsLbl, hostedByLbl, peopleLbl, bedsLbl, bedroomsLbl, readMoreBtn, locationLbl, chooseDayOfVacationLbl, numberOfPeople
    //LikedVC
    ...
    //HomeDetailVC
    case rules, additionalFeatures, showAllElementsBtn, commentByOwner, contactInfo, phoneLbl, comingTime, leavingTime, callBtn
    //MapVC
